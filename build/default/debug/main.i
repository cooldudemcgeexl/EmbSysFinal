...
void __attribute__((picinterrupt(("")))) rxISR()
{
    if (PIR1bits.RCIF == 1)
    {
        PORTB = 0xFF;
...
char readKey()
{
    ...
    TRISBbits.TRISB3 = 0;
    PORTBbits.RB3 = 1;
    bitMap[0][0] = PORTBbits.RB7;
    bitMap[1][0] = PORTBbits.RB6;
    bitMap[2][0] = PORTBbits.RB5;
    bitMap[3][0] = PORTBbits.RB4;
    PORTBbits.RB3 = 0;
    TRISBbits.TRISB3 = 1;

    TRISBbits.TRISB2 = 0;
    PORTBbits.RB2 = 1;
    bitMap[0][1] = PORTBbits.RB7;
    bitMap[1][1] = PORTBbits.RB6;
    bitMap[2][1] = PORTBbits.RB5;
    bitMap[3][1] = PORTBbits.RB4;
    PORTBbits.RB2 = 0;
    TRISBbits.TRISB2 = 1;
    ...
    TRISBbits.TRISB1 = 0;
    PORTBbits.RB1 = 1;
    bitMap[0][2] = PORTBbits.RB7;
    bitMap[1][2] = PORTBbits.RB6;
    bitMap[2][2] = PORTBbits.RB5;
    bitMap[3][2] = PORTBbits.RB4;
    PORTBbits.RB1 = 0;
    TRISBbits.TRISB1 = 1;

    TRISBbits.TRISB0 = 0;
    PORTBbits.RB0 = 1;
    bitMap[0][3] = PORTBbits.RB7;
    bitMap[1][3] = PORTBbits.RB6;
    bitMap[2][3] = PORTBbits.RB5;
    bitMap[3][3] = PORTBbits.RB4;
    PORTBbits.RB0 = 0;
    TRISBbits.TRISB0 = 1;
